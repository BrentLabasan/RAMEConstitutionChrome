...
window.onload = function() {
	...
	smithers = "http://brentlabasan.com/RCon/article_results.php?domain=" + document.domain + "&pathname=" + document.location.pathname ;
	resultsWindowHTML = "<iframe src='" + smithers + "' width='100%' height='100%'><p>Your browser does not support iframes.</p></iframe>";
	$("#resultsWindow").html(resultsWindowHTML);
	
	$("#clickHereToVote").mouseover( function() {
		//alert("fuck");
		...
		$("#viewRelevantAmendments").mouseover( function() {
		//alert("fuck");
		$(this).addClass("inverted");
		$(this).css("background-color","WHITE");
		$(this).css("color","BLACK");
		...
		$("#clickHereToVote").mouseout( function() {
		//alert("fuck");
		...
		$("#viewRelevantAmendments").mouseout( function() {
		//alert("fuck");
		$(this).removeClass("inverted");
		$(this).css("background-color","BLACK");
		$(this).css("color","WHITE");
